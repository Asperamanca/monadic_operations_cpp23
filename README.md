...
## Talk Versions
- Meeting C++, November 2025 ([Youtube](https://www.youtube.com/watch?v=lEDQJgaROlE)) - shorter version, ([find the 'missing pieces' in the C++ on Sea version](https://youtu.be/fyjJPwkVOuw?si=ZhEv9FuVIgndAS-L&t=3033))
...
- Paper: [std::optional<T&> (P2988)](https://open-std.org/jtc1/sc22/wg21/docs/papers/2025/p2988r12.pdf)
...
- [Flux - a C++20 library for sequence-oriented programming](https://github.com/tcbrindle/flux): An alternative to both std::ranges and Ranges v3, which promises both more safety and better performance
